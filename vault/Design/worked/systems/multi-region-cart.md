...
| --- | --- |
| Scale and traffic | 100,000 global read/write [[qps|QPS]], roughly 2:1 read to write |
...
**3. The [[write-ahead-log|WAL]] stream.** The database pushes the change event to its internal write ahead log.
...
This gives mathematical perfection with zero data loss. But it requires a highly specialised database, drastically increasing engineering complexity over native [[last-write-wins|LWW]]. For standard e-commerce, LWW is the accepted business trade off.
