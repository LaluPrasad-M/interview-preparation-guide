...
| **Safety** | Block injected scripts ([[cross-site-scripting]]), stop other sites acting as your user ([[cross-site-request-forgery|CSRF]]), tell the browser which scripts it may run ([[content-security-policy|Content Security Policy]]), check both who the user is and what they may do. |
