...
The most common approach for user facing applications. If a user updates their own profile they immediately see the update, while other users might temporarily see the old version.
